...
import app.argusos.extension.music.VersionCheckUtils;
import app.argusos.extension.music.settings.preference.MusicPreferenceFragment;
import app.argusos.extension.music.settings.search.MusicSearchViewController;
...
import app.argusos.extension.shared.settings.BaseActivityHook;
...
public class MusicActivityHook extends BaseActivityHook {
     ...
     *
     * @see app.argusos.extension.youtube.settings.YouTubeActivityHook#MINIMUM_TIME_AFTER_FIRST_LAUNCH_BEFORE_ALLOWING_BOLD_ICONS
     */
    ...
    protected void customizeActivityTheme(Activity activity) {
        ...
        activity.setTheme(Utils.getResourceIdentifierOrThrow(
                ResourceType.STYLE, "Theme.ArgusOS.YouTubeMusic.Settings"));
    }
