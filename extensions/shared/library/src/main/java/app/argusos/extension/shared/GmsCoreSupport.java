...
public class GmsCoreSupport {
    ...
    private static String getGmsCoreVendorGroupId() {
        return "app.argusos"; // Modified during patching.
    }
    ...
    private enum GmsCore {
        ARGUSOS("app.argusos", "https://github.com/argusos/gmscore/releases/latest", () -> {
            try {
                HttpURLConnection connection = Requester.getConnectionFromRoute(
                        "https://api.github.com",
                        new Route(GET, "/repos/argusos/gmscore/releases/latest")
                );
        ...
        private void checkInstallation(Activity context) {
            try {
                ...
                try {
                    ...
                    Utils.showToastLong(str("argusos_gms_core_toast_not_installed_message"));
                ...
                if (isAndroidAutomotive(context)) {
                    ...
                    showBatteryOptimizationDialog(context,
                            "argusos_gms_core_dialog_not_whitelisted_using_battery_optimizations_message",
                            "argusos_gms_core_dialog_continue_text",
                ...
                try {
                    if (client == null) {
                        ...
                        showBatteryOptimizationDialog(context,
                                "argusos_gms_core_dialog_not_whitelisted_not_allowed_in_background_message",
                                "gmsargusos_gms_core_log_open_website_text",
            ...
            Utils.runOnBackgroundThread(() -> {
                try {
                    ...
                    if (latestVersion == null || latestVersion.isEmpty()) {
                        ...
                        Utils.showToastLong(str("argusos_gms_core_toast_update_check_failed_message"));
                        return;
                    }
            ...
            Utils.runOnMainThreadDelayed(() -> {
                try {
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            context,
                            str("argusos_gms_core_dialog_title"),
                            String.format(str("argusos_gms_core_update_available_message"), latestVersion, installedVersion),
                            null,
                            str("argusos_gms_core_dialog_open_website_text"),
                            () -> open(downloadQuery),
                            () -> {
                            },
                            str("argusos_gms_core_dialog_cancel_text"),
                            null,
                            true
                    );
        ...
        private static void showBatteryOptimizationDialog(Activity context,
            ...
            Utils.runOnMainThreadDelayed(() -> {
                ...
                Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                        context,
                        str("argusos_gms_core_dialog_title"), // Title.
