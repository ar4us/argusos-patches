...
import static app.argusos.extension.shared.settings.BaseSettings.DEBUG;
import static app.argusos.extension.shared.settings.BaseSettings.DEBUG_STACKTRACE;
import static app.argusos.extension.shared.settings.BaseSettings.DEBUG_TOAST_ON_ERROR;
...
import app.argusos.extension.shared.settings.preference.LogBufferManager;

/**
 * ArgusOS specific logger. Logging is done to standard device log (accessible through ADB),
...
public class Logger {
     ...
     */
    private static final String ARGUSOS_LOG_TAG_PREFIX = "argusos: ";
     ...
     * with class name but without 'argusos:' prefix.
     *
