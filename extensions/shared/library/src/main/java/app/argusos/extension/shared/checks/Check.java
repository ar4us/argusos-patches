...
import static app.argusos.extension.shared.Utils.DialogFragmentOnStartAction;
...
abstract class Check {
    ...
    private static final Uri GOOD_SOURCE = Uri.parse("https://argusos.app");
    ...
    static void issueWarning(Activity activity, Collection<Check> failedChecks) {
        ...
        var message = Html.fromHtml(
                str("argusos_check_environment_failed_message", reasons.toString()),
        ...
        Utils.runOnMainThreadDelayed(() -> {
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    activity,
                    str("argusos_check_environment_failed_title"), // Title.
                    message, // Message.
                    null,    // No EditText.
                    str("argusos_check_environment_dialog_open_official_source_button"), // OK button text.
                    () -> {
                    ...
                    str("argusos_check_environment_dialog_ignore_button"), // Neutral button text.
                    () -> {
            ...
            iconView.setImageResource(Utils.getResourceIdentifierOrThrow(
                    ResourceType.DRAWABLE, "argusos_ic_dialog_alert"));
