package app.argusos.extension.shared.checks;
...
import static app.argusos.extension.shared.checks.Check.debugAlwaysShowWarning;
import static app.argusos.extension.shared.checks.PatchInfo.Build.*;
...
public final class CheckEnvironmentPatch {
    ...
    private enum InstallationType {
        ...
        MANAGER("app.argusos.manager.flutter",
                "app.argusos.manager.flutter.debug",
                "app.argusos.manager",
                "app.argusos.manager.debug");
     ...
     * or installed manually via ADB (in the case of ArgusOS CLI for example).
     * <br>
    ...
    private static class CheckExpectedInstaller extends Check {
        ...
        protected String failureReason() {
            return str("argusos_check_environment_manager_not_expected_installer");
        }
    ...
    private static class CheckWasPatchedOnSameDevice extends Check {
        ...
        @Override
        protected String failureReason() {
            return str("argusos_check_environment_not_same_patching_device");
        }
    ...
    private static class CheckIsNearPatchTime extends Check {
        ...
        protected String failureReason() {
            if (durationBetweenPatchingAndInstallation < 0) {
                ...
                return str("argusos_check_environment_not_near_patch_time_invalid");
            }
            ...
            if (daysSincePatching > 1) { // Use over 1 day to avoid singular vs plural strings.
                return str("argusos_check_environment_not_near_patch_time_days", daysSincePatching);
            }

            return str("argusos_check_environment_not_near_patch_time");
        }
