            ...
            try {
                ...
                Utils.runOnMainThread(() -> {
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            context,
                            str("argusos_check_watch_history_domain_name_dialog_title"), // Title.
                            Html.fromHtml(str("argusos_check_watch_history_domain_name_dialog_message")), // Message (HTML).
                            null, // No EditText.
                            null, // OK button text.
                            () -> {}, // OK button action (just dismiss).
                            null, // No cancel button.
                            str("argusos_check_watch_history_domain_name_dialog_ignore"), // Neutral button text.
