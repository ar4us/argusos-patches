...
import app.argusos.extension.shared.settings.preference.ToolbarPreferenceFragment;
...
public abstract class BaseActivityHook extends Activity {
    ...
    private static final int ID_ARGUSOS_SETTINGS_FRAGMENTS =
            getResourceIdentifierOrThrow(ResourceType.ID, "argusos_settings_fragments");
    private static final int ID_ARGUSOS_TOOLBAR_PARENT =
            getResourceIdentifierOrThrow(ResourceType.ID, "argusos_toolbar_parent");
    public static final int LAYOUT_ARGUSOS_SETTINGS_WITH_TOOLBAR =
            getResourceIdentifierOrThrow(ResourceType.LAYOUT, "argusos_settings_with_toolbar");
    private static final int STRING_ARGUSOS_SETTINGS_TITLE =
            getResourceIdentifierOrThrow(ResourceType.STRING, "argusos_settings_title");
    ...
    public static void initialize(BaseActivityHook hook, Activity activity) {
        try {
            ...
            if (!"argusos_settings_intent".equals(dataString)) {
            ...
            activity.getFragmentManager()
                    .beginTransaction()
                    .replace(ID_ARGUSOS_SETTINGS_FRAGMENTS, fragment)
                    .commit();
        } catch (Exception ex) {
    ...
    /**
     * Injection point.
     * Overrides the ArgusOS settings language.
     */
    @SuppressWarnings("unused")
    public static Context getAttachBaseContext(Context original) {
        AppLanguage language = BaseSettings.ARGUSOS_LANGUAGE.get();
    ...
    protected void createToolbar(Activity activity, PreferenceFragment fragment) {
        ...
        ViewGroup toolbarParent = activity.findViewById(ID_ARGUSOS_TOOLBAR_PARENT);
        ViewGroup dummyToolbar = Utils.getChildViewByResourceName(toolbarParent, "argusos_toolbar");
        ...
        toolbar.setTitle(STRING_ARGUSOS_SETTINGS_TITLE);
    ...
    protected int getContentViewResourceId() {
        return LAYOUT_ARGUSOS_SETTINGS_WITH_TOOLBAR;
    }
