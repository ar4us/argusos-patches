...
public class ArgusOSAboutPreference extends Preference {
    ...
    private String createDialogHtml(WebLink[] aboutLinks) {
        ...
        builder.append("<p>")
                ...
                .append(useNonBreakingHyphens(getString("argusos_settings_about_links_body", patchesVersion)))
                .append("</p>");
        ...
        if (patchesVersion.contains("dev")) {
            builder.append("<h3>")
                    ...
                    .append(useNonBreakingHyphens(getString("argusos_settings_about_links_dev_header")))
                    .append("</h3>");

            builder.append("<p>")
                    .append(getString("argusos_settings_about_links_dev_body"))
                    .append("</p>");
        }

        builder.append("<h2 style=\"margin-top: 30px;\">")
                .append(getString("argusos_settings_about_links_header"))
                .append("</h2>");
    ...
    public ArgusOSAboutPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }
    public ArgusOSAboutPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public ArgusOSAboutPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public ArgusOSAboutPreference(Context context) {
        super(context);
    }
}
...
class AboutLinksRoutes {
     ...
     */
    public static volatile String aboutLogoUrl = "https://argusos.app/favicon.ico";

    /**
     * Links to use if fetch links api call fails.
     */
    private static final WebLink[] NO_CONNECTION_STATIC_LINKS = {
            new WebLink(true, "ArgusOS.app", "https://argusos.app")
    };

    private static final String SOCIAL_LINKS_PROVIDER = "https://api.argusos.app/v4";
