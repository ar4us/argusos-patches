...
import app.argusos.extension.shared.ui.ColorDot;
...
public class ColorPickerPreference extends EditTextPreference {
    ...
    public static final int ID_ARGUSOS_COLOR_PICKER_VIEW =
            getResourceIdentifierOrThrow(ResourceType.ID, "argusos_color_picker_view");
    public static final int ID_PREFERENCE_COLOR_DOT =
            getResourceIdentifierOrThrow(ResourceType.ID, "preference_color_dot");
    public static final int LAYOUT_ARGUSOS_COLOR_DOT_WIDGET =
            getResourceIdentifierOrThrow(ResourceType.LAYOUT, "argusos_color_dot_widget");
    public static final int LAYOUT_ARGUSOS_COLOR_PICKER =
            getResourceIdentifierOrThrow(ResourceType.LAYOUT, "argusos_color_picker");
    ...
    private void init() {
        ...
        setWidgetLayoutResource(LAYOUT_ARGUSOS_COLOR_DOT_WIDGET);
    }
    ...
    public void setText(String colorString) {
        try {
            ...
            Utils.showToastShort(str("argusos_settings_color_invalid"));
    ...
    protected void showDialog(Bundle state) {
        ...
        View colorPicker = LayoutInflater.from(context).inflate(LAYOUT_ARGUSOS_COLOR_PICKER, null);
        dialogColorPickerView = colorPicker.findViewById(ID_ARGUSOS_COLOR_PICKER_VIEW);
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                getTitle() != null ? getTitle().toString() : str("argusos_settings_color_picker_title"),
                null,
                null,
                null,
                () -> { // OK button action.
                ...
                str("argusos_settings_reset_color"), // Neutral button text.
