...
public class CustomDialogListPreference extends ListPreference {
    ...
    public static final int ID_ARGUSOS_CHECK_ICON = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_check_icon");
    public static final int ID_ARGUSOS_CHECK_ICON_PLACEHOLDER = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_check_icon_placeholder");
    public static final int ID_ARGUSOS_ITEM_TEXT = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_item_text");
    public static final int LAYOUT_ARGUSOS_CUSTOM_LIST_ITEM_CHECKED = getResourceIdentifierOrThrow(
            ResourceType.LAYOUT, "argusos_custom_list_item_checked");
    public static final int DRAWABLE_CHECKMARK = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "argusos_settings_custom_checkmark");
    public static final int DRAWABLE_CHECKMARK_BOLD = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "argusos_settings_custom_checkmark_bold");
    ...
    public static class ListPreferenceArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.placeholder = view.findViewById(ID_ARGUSOS_CHECK_ICON_PLACEHOLDER);
                holder.itemText = view.findViewById(ID_ARGUSOS_ITEM_TEXT);
                holder.checkIcon = view.findViewById(ID_ARGUSOS_CHECK_ICON);
