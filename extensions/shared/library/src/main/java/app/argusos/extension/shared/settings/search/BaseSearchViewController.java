package app.argusos.extension.shared.settings.search;
...
import app.argusos.extension.shared.settings.AppLanguage;
import app.argusos.extension.shared.settings.BaseSettings;
import app.argusos.extension.shared.settings.Setting;
import app.argusos.extension.shared.settings.preference.ColorPickerPreference;
import app.argusos.extension.shared.settings.preference.CustomDialogListPreference;
import app.argusos.extension.shared.settings.preference.NoTitlePreferenceCategory;
import app.argusos.extension.shared.ui.Dim;

/**
 * Abstract controller for managing the overlay search view in ArgusOS settings.
...
public abstract class BaseSearchViewController {
    ...
    protected static final int ID_ARGUSOS_SEARCH_VIEW = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_search_view");
    protected static final int ID_ARGUSOS_SEARCH_VIEW_CONTAINER = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_search_view_container");
    protected static final int ID_ACTION_SEARCH = getResourceIdentifierOrThrow(
            ResourceType.ID, "action_search");
    protected static final int ID_ARGUSOS_SETTINGS_FRAGMENTS = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_settings_fragments");
    private static final int DRAWABLE_ARGUSOS_SETTINGS_SEARCH_ICON = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "argusos_settings_search_icon");
    private static final int DRAWABLE_ARGUSOS_SETTINGS_SEARCH_ICON_BOLD = getResourceIdentifierOrThrow(
            ResourceType.DRAWABLE, "argusos_settings_search_icon_bold");
    protected static final int MENU_ARGUSOS_SEARCH_MENU = getResourceIdentifierOrThrow(
            ResourceType.MENU, "argusos_search_menu");

    /**
     * @return The search icon, either bold or not bold, depending on the ArgusOS UI setting.
     */
    public static int getSearchIcon() {
        return Utils.appIsUsingBoldIcons()
                ? DRAWABLE_ARGUSOS_SETTINGS_SEARCH_ICON_BOLD
                : DRAWABLE_ARGUSOS_SETTINGS_SEARCH_ICON;
    }
    ...
    private void initializeSearchView() {
        ...
        searchView = activity.findViewById(ID_ARGUSOS_SEARCH_VIEW);
        ...
        searchContainer = activity.findViewById(ID_ARGUSOS_SEARCH_VIEW_CONTAINER);

        // Set background and query hint.
        searchView.setBackground(createBackgroundDrawable());
        searchView.setQueryHint(str("argusos_settings_search_hint"));
        ...
        AppLanguage appLanguage = BaseSettings.ARGUSOS_LANGUAGE.get();
    ...
    private void initializeOverlayContainer() {
        ...
        FrameLayout mainContainer = activity.findViewById(ID_ARGUSOS_SETTINGS_FRAGMENTS);
    ...
    protected void setupToolbarMenu() {
        toolbar.inflateMenu(MENU_ARGUSOS_SEARCH_MENU);
    ...
    protected void filterAndShowResults(String query) {
        ...
        if (filteredSearchItems.isEmpty()) {
            ...
            noResultsPreference.setTitle(str("argusos_settings_search_no_results_title", query));
            noResultsPreference.setSummary(str("argusos_settings_search_no_results_summary"));
