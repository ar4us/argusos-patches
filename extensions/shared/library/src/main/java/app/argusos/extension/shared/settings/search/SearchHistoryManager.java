...
import static app.argusos.extension.shared.settings.BaseSettings.SETTINGS_SEARCH_ENTRIES;
import static app.argusos.extension.shared.settings.BaseSettings.SETTINGS_SEARCH_HISTORY;
...
import app.argusos.extension.shared.settings.preference.BulletPointPreference;
...
public class SearchHistoryManager {
    ...
    private static final int ID_SEARCH_TIPS_SUMMARY = getResourceIdentifierOrThrow(
            ResourceType.ID, "argusos_settings_search_tips_summary");
    private static final int LAYOUT_ARGUSOS_PREFERENCE_SEARCH_HISTORY_SCREEN = getResourceIdentifierOrThrow(
            ResourceType.LAYOUT, "argusos_preference_search_history_screen");
    private static final int LAYOUT_ARGUSOS_PREFERENCE_SEARCH_HISTORY_ITEM = getResourceIdentifierOrThrow(
            ResourceType.LAYOUT, "argusos_preference_search_history_item");
    ...
    SearchHistoryManager(Activity activity, FrameLayout overlayContainer,
        ...
        View historyView = inflater.inflate(LAYOUT_ARGUSOS_PREFERENCE_SEARCH_HISTORY_SCREEN,
        ...
        clearHistoryButton.setOnClickListener(v -> createAndShowDialog(
                str("argusos_settings_search_clear_history"),
                str("argusos_settings_search_clear_history_message"),
                this::clearAllSearchHistory
        ));

        // Set up search tips summary.
        CharSequence text = BulletPointPreference.formatIntoBulletPoints(
                str("argusos_settings_search_tips_summary"));
    ...
    protected void showEmptyHistoryViews(TextView emptyTitle, TextView emptySummary) {
        ...
        emptyTitle.setText(str("argusos_settings_search_empty_history_title"));
        emptySummary.setVisibility(View.VISIBLE);
        emptySummary.setText(str("argusos_settings_search_empty_history_summary"));
    }
    ...
    protected class SearchHistoryAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            for (String query : history) {
                View view = inflater.inflate(LAYOUT_ARGUSOS_PREFERENCE_SEARCH_HISTORY_ITEM,
                        container, false);
                ...
                deleteIcon.setOnClickListener(v -> createAndShowDialog(
                        query,
                        str("argusos_settings_search_remove_message"),
                        () -> {
