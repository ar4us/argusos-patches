package app.argusos.extension.shared.spoof;
...
public enum ClientType {
    ...
    ANDROID_REEL(
            ...
            // This client can log in, but if an access token is used in the request, GVS can more easily identify the request as coming from ArgusOS.
