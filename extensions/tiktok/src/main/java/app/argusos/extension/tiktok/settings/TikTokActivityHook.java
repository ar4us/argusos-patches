package app.argusos.extension.tiktok.settings;
...
import app.argusos.extension.tiktok.settings.preference.TikTokPreferenceFragment;
...
public class TikTokActivityHook {
    public static Object createSettingsEntry(String entryClazzName, String entryInfoClazzName) {
        try {
            ...
            Object buttonInfo = entryInfoConstructor.newInstance(
                    "ArgusOS settings", null, (View.OnClickListener) view -> startSettingsActivity(), "argusos");
    ...
    public static boolean initialize(AdPersonalizationActivity base) {
        ...
        if (extras != null && !extras.getBoolean("argusos", false)) return false;
