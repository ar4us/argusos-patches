...
import app.argusos.extension.tiktok.settings.preference.categories.DownloadsPreferenceCategory;
import app.argusos.extension.tiktok.settings.preference.categories.ExtensionPreferenceCategory;
import app.argusos.extension.tiktok.settings.preference.categories.FeedFilterPreferenceCategory;
import app.argusos.extension.tiktok.settings.preference.categories.SimSpoofPreferenceCategory;
