package app.argusos.extension.twitch.api;

import androidx.annotation.NonNull;
import app.argusos.extension.shared.Logger;
import app.argusos.extension.shared.Utils;
import app.argusos.extension.twitch.adblock.IAdblockService;
import app.argusos.extension.twitch.adblock.LuminousService;
import app.argusos.extension.twitch.adblock.PurpleAdblockService;
...
public class RequestInterceptor implements Interceptor {
    ...
    private static final String PROXY_DISABLED = str("argusos_block_embedded_ads_entry_1");
    private static final String LUMINOUS_SERVICE = str("argusos_block_embedded_ads_entry_2");
    private static final String PURPLE_ADBLOCK_SERVICE = str("argusos_block_embedded_ads_entry_3");
        ...
        if (activeService != null) {
            ...
            if (!available || rewritten == null) {
                Utils.showToastShort(String.format(
                        str("argusos_embedded_ads_service_unavailable"), activeService.friendlyName()
                ));
                return chain.proceed(originalRequest);
            }
            ...
            Utils.showToastLong(String.format(
                    str("argusos_embedded_ads_service_failed"),
