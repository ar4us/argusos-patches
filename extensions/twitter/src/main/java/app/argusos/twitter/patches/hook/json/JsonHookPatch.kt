package app.argusos.extension.twitter.patches.hook.json

import app.argusos.extension.twitter.patches.hook.patch.dummy.DummyHook
import app.argusos.extension.twitter.utils.json.JsonUtils.parseJson
