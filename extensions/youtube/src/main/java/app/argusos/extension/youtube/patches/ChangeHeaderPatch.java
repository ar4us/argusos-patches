...
public class ChangeHeaderPatch {
    ...
    public enum HeaderLogo {
        ...
        ROUNDED("argusos_header_rounded"),
        MINIMAL("argusos_header_minimal"),
        CUSTOM("argusos_header_custom"),

        // Old enum names for data migration. TODO: Eventually delete these.
        @Deprecated
        ARGUSOS(ROUNDED.attributeName),
        @Deprecated
        ARGUSOS_MINIMAL(MINIMAL.attributeName);
