...
import static app.argusos.extension.youtube.patches.VersionCheckPatch.*;
...
public final class MiniplayerPatch {
    ...
    static {
        ...
        if (dipWidth < WIDTH_DIP_MIN || dipWidth > WIDTH_DIP_MAX) {
            Utils.showToastLong(str("argusos_miniplayer_width_dip_invalid_toast",
    ...
    static {
        ...
        if (opacity < 0 || opacity > 100) {
            Utils.showToastLong(str("argusos_miniplayer_opacity_invalid_toast"));
