package app.argusos.extension.youtube.patches.announcements;

import static android.text.Html.FROM_HTML_MODE_COMPACT;
import static app.argusos.extension.shared.StringRef.str;
import static app.argusos.extension.youtube.patches.announcements.requests.AnnouncementsRoutes.GET_LATEST_ANNOUNCEMENTS;
import static app.argusos.extension.youtube.patches.announcements.requests.AnnouncementsRoutes.GET_LATEST_ANNOUNCEMENT_IDS;
...
import app.argusos.extension.youtube.patches.announcements.requests.AnnouncementsRoutes;
    ...
    private static boolean isLatestAlready() throws IOException {
        ...
        try {
            ...
            if (connection.getResponseCode() != 200) {
                ...
                Utils.showToastLong(str("argusos_announcements_connection_failed"));
            ...
            try {
                ...
                Utils.runOnMainThread(() -> {
                    ...
                    Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                            ...
                            str("argusos_announcements_dialog_dismiss"), // Neutral button text.
