...
import static app.argusos.extension.youtube.shared.NavigationBar.NavigationButton;
...
import app.argusos.extension.shared.ByteTrieSearch;
import app.argusos.extension.shared.StringTrieSearch;
import app.argusos.extension.shared.TrieSearch;
import app.argusos.extension.shared.patches.litho.Filter;
import app.argusos.extension.shared.patches.litho.FilterGroup.*;
import app.argusos.extension.youtube.settings.Settings;
import app.argusos.extension.youtube.shared.NavigationBar;
...
public final class KeywordContentFilter extends Filter {
        ...
        if (split.length != 0) {
            ...
            for (String phrase : split) {
                ...
                if (phraseUsesWholeWordSyntax(phrase)) {
                    ...
                    Utils.showToastLong(str("argusos_hide_keyword_toast_invalid_length", phrase, MINIMUM_KEYWORD_LENGTH));
                    continue;
                } else {
                ...
                if (phrasesWillHideAllVideos(phraseVariations, wholeWordMatching)) {
                    ...
                    if (!wholeWordMatching && !phrasesWillHideAllVideos(phraseVariations, true)) {
                        toastMessage = "argusos_hide_keyword_toast_invalid_common_whole_word_required";
                    } else {
                        toastMessage = "argusos_hide_keyword_toast_invalid_common";
                    }
                ...
                for (String variation : phraseVariations) {
                    ...
                    if (existing == null) {
                        ...
                        Utils.showToastLong(str("argusos_hide_keyword_toast_invalid_conflicting", phrase));
                        break;
                    }
                }
            }
    ...
    private void updateStats(boolean videoWasHidden, @Nullable String keyword) {
        ...
        Utils.showToastLong(str("argusos_hide_keyword_toast_invalid_broad", keyword));
    }
