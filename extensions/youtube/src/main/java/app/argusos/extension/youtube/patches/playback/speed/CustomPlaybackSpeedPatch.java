package app.argusos.extension.youtube.patches.playback.speed;
...
import app.argusos.extension.youtube.patches.litho.PlaybackSpeedMenuFilter;
...
public class CustomPlaybackSpeedPatch {
    ...
    private static void showInvalidCustomSpeedToast() {
        Utils.showToastLong(str("argusos_custom_playback_speeds_invalid", PLAYBACK_SPEED_MAXIMUM));
    }
    ...
    private static float[] loadCustomSpeeds() {
        try {
            ...
            Utils.showToastShort(str("argusos_custom_playback_speeds_parse_exception"));
            Settings.CUSTOM_PLAYBACK_SPEEDS.resetToDefault();
            return loadCustomSpeeds();
        }
    }
