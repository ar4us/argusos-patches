package app.argusos.extension.youtube.returnyoutubedislike;
...
import app.argusos.extension.youtube.returnyoutubedislike.requests.RYDVoteData;
    ...
    private static SpannableString createDislikeSpan(@NonNull Spanned oldSpannable,
        ...
        if (!Utils.containsNumber(oldLikes)) {
            ...
            if (!Settings.RYD_ESTIMATED_LIKE.get()) {
                ...
                String hiddenMessageString = str("argusos_ryd_video_likes_hidden_by_video_owner");
        ...
        try {
            ...
            if (votingData == null) {
                ...
                ReturnYouTubeDislikeAPI.handleConnectionError(
                        str("argusos_ryd_failure_connection_timeout"),
    ...
    public void sendVote(@NonNull Vote vote) {
        ...
        try {
            ...
            if (isShort != currentType.isNoneHiddenOrMinimized()) {
                ...
                Utils.showToastLong(str("argusos_ryd_failure_ryd_enabled_while_playing_video_then_user_voted"));
                return;
            }
