...
public class ExternalDownloaderPreference extends CustomDialogListPreference {
    ...
    private enum Downloader {
        ...
        OTHER(sf("argusos_external_downloader_other_item").toString(),
                null,
                null,
                true);
    ...
    public void setSummary(CharSequence summary) {
        ...
        //
        // This is required otherwise the ArgusOS preference fragment
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                ...
                () -> {
                    ...
                    if (newValue.isEmpty()) {
                        ...
                        CustomDialog.create(
                                context,
                                str("argusos_external_downloader_name_title"),
                                str("argusos_external_downloader_empty_warning"),
                                null,
                                null,
    ...
    private EditText createEditText(Context context,
        ...
        editText.setHint(str("argusos_external_downloader_other_item_hint"));
    ...
    public static boolean showDialogIfAppIsNotInstalled(Context context, String packageName) {
        ...
        String message = downloader != null
                ? str("argusos_external_downloader_not_installed_warning", downloader.name)
                : str("argusos_external_downloader_package_not_found_warning", packageName);

        CustomDialog.create(
                context,
                str("argusos_external_downloader_not_found_title"),
                message,
                null,
                okButtonText,
                () -> {
