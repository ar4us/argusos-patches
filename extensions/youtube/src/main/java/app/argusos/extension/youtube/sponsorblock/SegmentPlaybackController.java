...
import app.argusos.extension.youtube.shared.ShortsPlayerState;
import app.argusos.extension.youtube.shared.VideoState;
        ...
        Utils.runOnMainThreadDelayed(() -> {
            try {
                ...
                String message = toastNumberOfSegmentsSkipped == 1
                        ...
                        : str("argusos_sb_skipped_multiple_segments");
