...
import app.argusos.extension.youtube.sponsorblock.ui.SponsorBlockPreferenceGroup;
...
public class SponsorBlockSettings {
        ...
        try {
            ...
            for (SegmentCategory category : SegmentCategory.categoriesWithoutUnsubmitted()) {
                ...
                if (barTypesObject.has(category.keyValue)) {
                    ...
                    // Older ArgusOS SB exports lack an opacity value.
            ...
            if (isValidSBServerAddress(serverAddress)) { // Old versions of ArgusOS exported wrong url format.
            ...
            if (settingsJson.has("skipCount")) { // Value not exported in old versions of ArgusOS.
            ...
            Utils.showToastLong(str("argusos_sb_settings_import_successful"));
        } catch (Exception ex) {
            Logger.printInfo(() -> "failed to import settings", ex); // Use info level, as we are showing our own toast.
            Utils.showToastLong(str("argusos_sb_settings_import_failed", ex.getMessage()));
        }
    }
    ...
    public static String exportDesktopSettings() {
        ...
        try {
            ...
            Utils.showToastLong(str("argusos_sb_settings_export_failed", ex));
            return "";
        }
    }
    ...
    private static void showExportWarningIfNeeded(@Nullable Context dialogContext) {
        ...
        if (dialogContext != null && SponsorBlockSettings.userHasSBPrivateID()
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    dialogContext,
                    null, // No title.
                    str("argusos_sb_settings_argusos_export_user_id_warning"), // Message.
                    null, // No EditText.
                    null, // OK button text.
                    () -> {}, // OK button action (dismiss only).
                    null, // No cancel button action.
                    str("argusos_sb_settings_argusos_export_user_id_warning_dismiss"), // Neutral button text.
