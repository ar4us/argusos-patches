package app.argusos.extension.youtube.sponsorblock.objects;

import static app.argusos.extension.shared.StringRef.sf;
import static app.argusos.extension.youtube.settings.Settings.*;
...
import app.argusos.extension.shared.StringRef;
...
public enum SegmentCategory {
    SPONSOR("sponsor", sf("argusos_sb_segments_sponsor"), sf("argusos_sb_segments_sponsor_sum"), sf("argusos_sb_skip_button_sponsor"), sf("argusos_sb_skipped_sponsor"),
            SB_CATEGORY_SPONSOR, SB_CATEGORY_SPONSOR_COLOR),
    SELF_PROMO("selfpromo", sf("argusos_sb_segments_selfpromo"), sf("argusos_sb_segments_selfpromo_sum"), sf("argusos_sb_skip_button_selfpromo"), sf("argusos_sb_skipped_selfpromo"),
            SB_CATEGORY_SELF_PROMO, SB_CATEGORY_SELF_PROMO_COLOR),
    INTERACTION("interaction", sf("argusos_sb_segments_interaction"), sf("argusos_sb_segments_interaction_sum"), sf("argusos_sb_skip_button_interaction"), sf("argusos_sb_skipped_interaction"),
            SB_CATEGORY_INTERACTION, SB_CATEGORY_INTERACTION_COLOR),
    /**
     * Unique category that is treated differently than the rest.
     */
    HIGHLIGHT("poi_highlight", sf("argusos_sb_segments_highlight"), sf("argusos_sb_segments_highlight_sum"), sf("argusos_sb_skip_button_highlight"), sf("argusos_sb_skipped_highlight"),
            SB_CATEGORY_HIGHLIGHT, SB_CATEGORY_HIGHLIGHT_COLOR),
    INTRO("intro", sf("argusos_sb_segments_intro"), sf("argusos_sb_segments_intro_sum"),
            sf("argusos_sb_skip_button_intro_beginning"), sf("argusos_sb_skip_button_intro_middle"), sf("argusos_sb_skip_button_intro_end"),
            sf("argusos_sb_skipped_intro_beginning"), sf("argusos_sb_skipped_intro_middle"), sf("argusos_sb_skipped_intro_end"),
            SB_CATEGORY_INTRO, SB_CATEGORY_INTRO_COLOR),
    OUTRO("outro", sf("argusos_sb_segments_outro"), sf("argusos_sb_segments_outro_sum"), sf("argusos_sb_skip_button_outro"), sf("argusos_sb_skipped_outro"),
            SB_CATEGORY_OUTRO, SB_CATEGORY_OUTRO_COLOR),
    PREVIEW("preview", sf("argusos_sb_segments_preview"), sf("argusos_sb_segments_preview_sum"),
            sf("argusos_sb_skip_button_preview_beginning"), sf("argusos_sb_skip_button_preview_middle"), sf("argusos_sb_skip_button_preview_end"),
            sf("argusos_sb_skipped_preview_beginning"), sf("argusos_sb_skipped_preview_middle"), sf("argusos_sb_skipped_preview_end"),
            SB_CATEGORY_PREVIEW, SB_CATEGORY_PREVIEW_COLOR),
    HOOK("hook", sf("argusos_sb_segments_hook"), sf("argusos_sb_segments_hook_sum"), sf("argusos_sb_skip_button_hook"), sf("argusos_sb_skipped_hook"),
            SB_CATEGORY_HOOK, SB_CATEGORY_HOOK_COLOR),
    FILLER("filler", sf("argusos_sb_segments_filler"), sf("argusos_sb_segments_filler_sum"), sf("argusos_sb_skip_button_filler"), sf("argusos_sb_skipped_filler"),
            SB_CATEGORY_FILLER, SB_CATEGORY_FILLER_COLOR),
    MUSIC_OFFTOPIC("music_offtopic", sf("argusos_sb_segments_nomusic"), sf("argusos_sb_segments_nomusic_sum"), sf("argusos_sb_skip_button_nomusic"), sf("argusos_sb_skipped_nomusic"),
            SB_CATEGORY_MUSIC_OFFTOPIC, SB_CATEGORY_MUSIC_OFFTOPIC_COLOR),
    UNSUBMITTED("unsubmitted", StringRef.empty, StringRef.empty, sf("argusos_sb_skip_button_unsubmitted"), sf("argusos_sb_skipped_unsubmitted"),
            SB_CATEGORY_UNSUBMITTED, SB_CATEGORY_UNSUBMITTED_COLOR);

    private static final StringRef skipSponsorTextCompact = sf("argusos_sb_skip_button_compact");
    private static final StringRef skipSponsorTextCompactHighlight = sf("argusos_sb_skip_button_compact_highlight");
    ...
    private void loadFromSettings() {
        ...
        CategoryBehaviour savedBehavior = CategoryBehaviour.byArgusOSKeyValue(behaviorString);
