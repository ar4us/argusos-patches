...
import static app.argusos.extension.youtube.sponsorblock.SponsorBlockSettings.migrateOldColorString;
...
public class SegmentCategoryPreference extends ColorPickerPreference {
    ...
    protected void onDialogOkClicked() {
        if (selectedDialogEntryIndex >= 0 && entryValues != null) {
            ...
            category.setBehaviour(Objects.requireNonNull(CategoryBehaviour.byArgusOSKeyValue(value)));
