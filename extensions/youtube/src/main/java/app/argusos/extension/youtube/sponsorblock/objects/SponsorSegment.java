...
public class SponsorSegment implements Comparable<SponsorSegment> {
    ...
    public enum SegmentVote {
        UPVOTE(sf("argusos_sb_vote_upvote"), 1,false),
        DOWNVOTE(sf("argusos_sb_vote_downvote"), 0, true),
        CATEGORY_CHANGE(sf("argusos_sb_vote_category"), -1, true); // ApiVoteType is not used for category change.
