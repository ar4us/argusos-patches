...
public final class NewSegmentLayout extends FrameLayout {
    ...
    public NewSegmentLayout(final Context context, final AttributeSet attributeSet,
        ...
        LayoutInflater.from(context).inflate(getResourceIdentifierOrThrow(context,
                ResourceType.LAYOUT,  "argusos_sb_new_segment"), this, true
        );

        initializeButton(
                context,
                "argusos_sb_new_segment_rewind",
        ...
        initializeButton(
                context,
                "argusos_sb_new_segment_forward",
                () -> VideoInformation.seekToRelative(Settings.SB_CREATE_NEW_SEGMENT_STEP.get()),
        ...
        initializeButton(
                context,
                "argusos_sb_new_segment_compare",
        ...
        initializeButton(
                context,
                "argusos_sb_new_segment_publish",
