...
import static app.argusos.extension.shared.Utils.getResourceColor;
import static app.argusos.extension.shared.Utils.getResourceDimension;
import static app.argusos.extension.shared.Utils.getResourceDimensionPixelSize;
import static app.argusos.extension.shared.Utils.getResourceIdentifier;
...
public class SkipSponsorButton extends FrameLayout {
    ...
    public SkipSponsorButton(Context context, AttributeSet attributeSet, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(getResourceIdentifierOrThrow(context, ResourceType.LAYOUT, "argusos_sb_skip_sponsor_button"), this, true);  // layout:skip_ad_button
        ...
        skipSponsorBtnContainer = Objects.requireNonNull(findViewById(getResourceIdentifierOrThrow(
                context, ResourceType.ID, "argusos_sb_skip_sponsor_button_container")));  // id:skip_ad_button_container
        ...
        skipSponsorTextView = Objects.requireNonNull(findViewById(getResourceIdentifier(context, ResourceType.ID, "argusos_sb_skip_sponsor_button_text")));  // id:skip_ad_button_text;
