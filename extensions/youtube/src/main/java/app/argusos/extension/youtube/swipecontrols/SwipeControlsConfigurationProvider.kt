...
class SwipeControlsConfigurationProvider {
    ...
    val overlayBackgroundOpacity: Int by lazy {
        ...
        if (opacity !in 0..100) {
            Utils.showToastLong(str("argusos_swipe_overlay_background_opacity_invalid_toast"))
    ...
    private fun getSettingColor(setting: StringSetting): Int {
        return try {
            ...
            Utils.showToastLong(str("argusos_settings_color_invalid"))
    ...
    val overlayTextSize: Int by lazy {
        ...
        if (size !in 1..30) {
            Utils.showToastLong(str("argusos_swipe_text_overlay_size_invalid_toast"))
