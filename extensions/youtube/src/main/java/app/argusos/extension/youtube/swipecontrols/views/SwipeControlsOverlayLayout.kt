package app.argusos.extension.youtube.swipecontrols.views
...
import app.argusos.extension.shared.StringRef.str
import app.argusos.extension.shared.Utils
import app.argusos.extension.youtube.swipecontrols.SwipeControlsConfigurationProvider
import app.argusos.extension.youtube.swipecontrols.misc.SwipeControlsOverlay
...
class SwipeControlsOverlayLayout(
    ...
    private val autoBrightnessIcon: Drawable = getDrawable("argusos_ic_sc_brightness_auto")
    private val lowBrightnessIcon: Drawable = getDrawable("argusos_ic_sc_brightness_low")
    private val mediumBrightnessIcon: Drawable = getDrawable("argusos_ic_sc_brightness_medium")
    private val highBrightnessIcon: Drawable = getDrawable("argusos_ic_sc_brightness_high")
    private val fullBrightnessIcon: Drawable = getDrawable("argusos_ic_sc_brightness_full")
    private val mutedVolumeIcon: Drawable = getDrawable("argusos_ic_sc_volume_mute")
    private val lowVolumeIcon: Drawable = getDrawable("argusos_ic_sc_volume_low")
    private val normalVolumeIcon: Drawable = getDrawable("argusos_ic_sc_volume_normal")
    private val fullVolumeIcon: Drawable = getDrawable("argusos_ic_sc_volume_high")
    ...
    override fun onBrightnessChanged(brightness: Double) {
        if (config.shouldLowestValueEnableAutoBrightness && brightness <= 0) {
            ...
            else str("argusos_swipe_lowest_value_enable_auto_brightness_overlay_text")
