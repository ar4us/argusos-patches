...
import app.argusos.extension.youtube.patches.playback.speed.CustomPlaybackSpeedPatch;
    ...
    public static void initializeButton(View controlsView) {
        try {
            instance = new PlayerControlButton(
                    controlsView,
                    "argusos_playback_speed_dialog_button_container",
                    "argusos_playback_speed_dialog_button",
                    "argusos_playback_speed_dialog_button_text",
