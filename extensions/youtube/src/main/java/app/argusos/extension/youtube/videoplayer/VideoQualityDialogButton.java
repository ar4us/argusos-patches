package app.argusos.extension.youtube.videoplayer;

import static app.argusos.extension.shared.StringRef.str;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.*;
import static app.argusos.extension.youtube.patches.VideoInformation.AUTOMATIC_VIDEO_QUALITY_VALUE;
import static app.argusos.extension.youtube.patches.VideoInformation.isPremiumVideoQuality;
import static app.argusos.extension.youtube.videoplayer.PlayerControlButton.fadeInDuration;
import static app.argusos.extension.youtube.videoplayer.PlayerControlButton.getDialogBackgroundColor;
...
import app.argusos.extension.shared.ui.SheetBottomDialog;
...
import app.argusos.extension.youtube.patches.VideoInformation.VideoQualityInterface;
import app.argusos.extension.youtube.patches.playback.quality.RememberVideoQualityPatch;
    ...
    public static void initializeButton(View controlsView) {
        try {
            instance = new PlayerControlButton(
                    controlsView,
                    "argusos_video_quality_dialog_button_container",
                    "argusos_video_quality_dialog_button",
                    "argusos_video_quality_dialog_button_text",
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(
                        LAYOUT_ARGUSOS_CUSTOM_LIST_ITEM_CHECKED,
                        parent,
                        false
                );
                viewHolder = new ViewHolder();
                viewHolder.checkIcon = convertView.findViewById(ID_ARGUSOS_CHECK_ICON);
                viewHolder.placeholder = convertView.findViewById(ID_ARGUSOS_CHECK_ICON_PLACEHOLDER);
                viewHolder.textView = convertView.findViewById(ID_ARGUSOS_ITEM_TEXT);
