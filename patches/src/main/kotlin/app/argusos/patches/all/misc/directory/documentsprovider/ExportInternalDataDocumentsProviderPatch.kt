package app.argusos.patches.all.misc.directory.documentsprovider

import app.revanced.patcher.patch.bytecodePatch
import app.revanced.patcher.patch.resourcePatch
import app.argusos.util.asSequence
...
val exportInternalDataDocumentsProviderPatch = resourcePatch(
    ...
    apply {
        val documentsProviderClass =
            "app.argusos.extension.all.misc.directory.documentsprovider.InternalDataDocumentsProvider"
