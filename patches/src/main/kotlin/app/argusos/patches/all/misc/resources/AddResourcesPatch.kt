package app.argusos.patches.all.misc.resources
...
import app.argusos.util.resource.ArrayResource
import app.argusos.util.resource.BaseResource
import app.argusos.util.resource.StringResource
...
) = app.argusos.patches.all.misc.resources.resources.getOrPut(value, ::mutableSetOf).addAll(resources)
