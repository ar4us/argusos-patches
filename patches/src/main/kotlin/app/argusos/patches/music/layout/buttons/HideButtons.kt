package app.argusos.patches.music.layout.buttons
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/music/patches/HideButtonsPatch;"
...
val hideButtonsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.GENERAL.addPreferences(
            SwitchPreference("argusos_music_hide_cast_button"),
            SwitchPreference("argusos_music_hide_history_button"),
            SwitchPreference("argusos_music_hide_notification_button"),
            SwitchPreference("argusos_music_hide_search_button"),
        )
