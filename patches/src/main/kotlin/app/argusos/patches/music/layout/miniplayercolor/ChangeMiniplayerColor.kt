...
package app.argusos.patches.music.layout.miniplayercolor
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/music/patches/ChangeMiniplayerColorPatch;"
...
val changeMiniplayerColorPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_change_miniplayer_color"),
        )
