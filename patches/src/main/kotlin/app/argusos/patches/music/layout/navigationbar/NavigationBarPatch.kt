package app.argusos.patches.music.layout.navigationbar
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/music/patches/NavigationBarPatch;"
    ...
    apply {
        ...
        PreferenceScreen.GENERAL.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_music_navigation_bar_screen",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("argusos_music_hide_navigation_bar_home_button"),
                    SwitchPreference("argusos_music_hide_navigation_bar_samples_button"),
                    SwitchPreference("argusos_music_hide_navigation_bar_explore_button"),
                    SwitchPreference("argusos_music_hide_navigation_bar_library_button"),
                    SwitchPreference("argusos_music_hide_navigation_bar_upgrade_button"),

                    SwitchPreference("argusos_music_hide_navigation_bar"),
                    SwitchPreference("argusos_music_hide_navigation_bar_labels"),
                ),
            ),
        )
