package app.argusos.patches.music.layout.premium
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/music/patches/HideGetPremiumPatch;"
...
val hideGetMusicPremiumPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.ADS.addPreferences(
            SwitchPreference("argusos_music_hide_get_premium_label"),
        )
