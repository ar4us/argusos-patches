...
package app.argusos.patches.samsung.radio.misc.fix.crash

import app.revanced.patcher.extensions.addInstructions
import app.revanced.patcher.extensions.getInstruction
import app.revanced.patcher.patch.bytecodePatch
import app.argusos.patches.samsung.radio.restrictions.device.bypassDeviceChecksPatch
...
private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/argusos/extension/samsung/radio/misc/fix/crash/FixCrashPatch;"

@Suppress("unused")
val fixCrashesPatch = bytecodePatch(
    name = "Fix crashes",
