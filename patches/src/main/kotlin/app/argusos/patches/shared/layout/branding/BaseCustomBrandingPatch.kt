...
import app.argusos.util.Utils.trimIndentMultiline
...
private const val LAUNCHER_RESOURCE_NAME_PREFIX = "argusos_launcher_"
private const val LAUNCHER_ADAPTIVE_BACKGROUND_PREFIX = "argusos_adaptive_background_"
private const val LAUNCHER_ADAPTIVE_FOREGROUND_PREFIX = "argusos_adaptive_foreground_"
private const val LAUNCHER_ADAPTIVE_MONOCHROME_PREFIX = "argusos_adaptive_monochrome_"
private const val NOTIFICATION_ICON_NAME = "argusos_notification_icon"
...
internal const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/shared/patches/CustomBrandingPatch;"
...
internal fun baseCustomBrandingPatch(
            ...
            document("AndroidManifest.xml").use { document ->
                ...
                application.setAttribute(
                    ...
                    if (useCustomName) {
                        ...
                        "@string/argusos_custom_branding_name_entry_2"
                    }
                )
            }
        }
    ...
    apply {
        ...
        preferenceScreen.addPreferences(
            if (useCustomName) {
                ListPreference(
                    key = "argusos_custom_branding_name",
                    entriesKey = "argusos_custom_branding_name_custom_entries",
                    entryValuesKey = "argusos_custom_branding_name_custom_entry_values",
                )
            } else {
                ListPreference("argusos_custom_branding_name")
            },
            if (useCustomIcon) {
                ListPreference(
                    key = "argusos_custom_branding_icon",
                    entriesKey = "argusos_custom_branding_icon_custom_entries",
                    entryValuesKey = "argusos_custom_branding_icon_custom_entry_values",
                )
            } else {
                ListPreference("argusos_custom_branding_icon")
            },
        )
        ...
        document("AndroidManifest.xml").use { document ->
            ...
            fun createAlias(
                ...
                val label = if (useCustomName) {
                    ...
                    "@string/argusos_custom_branding_name_entry_$appNameIndex"
                }
            ...
            if (useCustomIcon) {
                application.setAttribute(
                    "android:icon",
                    "@mipmap/argusos_launcher_custom"
                )
            }
            ...
            for (appNameIndex in 1..numberOfPresetAppNames) {
                fun aliasName(name: String): String = ".argusos_" + name + '_' + appNameIndex
