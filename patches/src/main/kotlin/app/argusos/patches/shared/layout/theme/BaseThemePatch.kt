package app.argusos.patches.shared.layout.theme
...
import app.argusos.util.childElementsSequence
import java.util.*
...
internal fun baseThemeResourcePatch(
    ...
    apply {
        // After patch option validators are fixed https://github.com/ArgusOS/argusos-patcher/issues/372
