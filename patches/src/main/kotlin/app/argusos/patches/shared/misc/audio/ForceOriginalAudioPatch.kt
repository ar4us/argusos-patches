package app.argusos.patches.shared.misc.audio
...
import app.argusos.util.cloneMutable
import app.argusos.util.findMethodFromToString
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/shared/patches/ForceOriginalAudioPatch;"
...
internal fun forceOriginalAudioPatch(
    ...
    apply {
        ...
        preferenceScreen.addPreferences(
            SwitchPreference(
                key = "argusos_force_original_audio",
                tag = "app.argusos.extension.shared.settings.preference.ForceOriginalAudioSwitchPreference",
            ),
        )
