package app.argusos.patches.shared.misc.debugging
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/shared/patches/EnableDebuggingPatch;"
...
internal fun enableDebuggingPatch(
            ...
            apply {
                copyResources(
                    ...
                    ResourceGroup(
                        "drawable",
                        // Action buttons.
                        "argusos_settings_copy_all.xml",
                        "argusos_settings_deselect_all.xml",
                        "argusos_settings_select_all.xml",
                        // Move buttons.
                        "argusos_settings_arrow_left_double.xml",
                        "argusos_settings_arrow_left_one.xml",
                        "argusos_settings_arrow_right_double.xml",
                        "argusos_settings_arrow_right_one.xml"
                    )
                )
            }
        }
    ...
    apply {
        ...
        val preferences = mutableSetOf<BasePreference>(
            SwitchPreference("argusos_debug"),
        )

        preferences + additionalDebugPreferences

        preferences += listOf(
            SwitchPreference("argusos_debug_protocolbuffer"),
            SwitchPreference("argusos_debug_stacktrace"),
            SwitchPreference("argusos_debug_toast_on_error"),
            NonInteractivePreference(
                "argusos_debug_export_logs_to_clipboard",
                tag = "app.argusos.extension.shared.settings.preference.ExportLogToClipboardPreference",
                selectable = true
            ),
            NonInteractivePreference(
                "argusos_debug_logs_clear_buffer",
                tag = "app.argusos.extension.shared.settings.preference.ClearLogBufferPreference",
                selectable = true
            ),
            NonInteractivePreference(
                "argusos_debug_feature_flags_manager",
                tag = "app.argusos.extension.shared.settings.preference.FeatureFlagsManagerPreference",
                selectable = true
            )
        )
