...
import app.argusos.patches.all.misc.packagename.changePackageNamePatch
...
import app.argusos.patches.shared.misc.gms.Constants.APP_AUTHORITIES
import app.argusos.patches.shared.misc.gms.Constants.APP_PERMISSIONS
import app.argusos.patches.shared.misc.gms.Constants.GMS_AUTHORITIES
import app.argusos.patches.shared.misc.gms.Constants.GMS_PERMISSIONS
...
internal const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/argusos/extension/shared/GmsCoreSupport;"
...
fun gmsCoreSupportPatch(
    ...
    val gmsCoreVendorGroupIdOption = stringOption(
        ...
        default = "app.argusos",
        values = mapOf("ArgusOS" to "app.argusos"),
        ...
        document("AndroidManifest.xml").use { document ->
            ...
            applicationNode.appendChild(
                document.createElement("meta-data").apply {
                    ...
                    setAttribute("android:name", "app.argusos.MICROG_PACKAGE_NAME")
