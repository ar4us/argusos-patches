...
package app.argusos.patches.shared.misc.litho.filter

import app.argusos.util.getFreeRegisterProvider
...
import app.argusos.util.findFieldFromToString
...
internal const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/shared/patches/litho/LithoFilterPatch;"
...
internal fun lithoFilterPatch(
    ...
    apply {
        ...
        lithoFilterInitMethod.apply {
            ...
            addInstructions(
                0,
                "new-array v1, v1, [Lapp/argusos/extension/shared/patches/litho/Filter;"
            )
