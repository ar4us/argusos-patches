package app.argusos.patches.tiktok.interaction.cleardisplay
        ...
        onClearDisplayEventMethod.apply {
            ...
            addInstructions(
                ...
                "invoke-static { v$isEnabledRegister }, " +
                    "Lapp/argusos/extension/tiktok/cleardisplay/RememberClearDisplayPatch;->rememberClearDisplayState(Z)V",
            )
            ...
            onRenderFirstFrameMethod.addInstructionsWithLabels(
                ...
                """
                    ...
                    invoke-static { }, Lapp/argusos/extension/tiktok/cleardisplay/RememberClearDisplayPatch;->getClearDisplayState()Z
                    move-result v4
