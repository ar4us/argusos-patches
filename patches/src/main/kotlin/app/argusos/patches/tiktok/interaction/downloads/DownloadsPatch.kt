package app.argusos.patches.tiktok.interaction.downloads
...
private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/argusos/extension/tiktok/download/DownloadsPatch;"
...
val downloadsPatch = bytecodePatch(
    ...
    apply {
        ...
        settingsStatusLoadMethod.addInstruction(
            0,
            "invoke-static {}, Lapp/argusos/extension/tiktok/settings/SettingsStatus;->enableDownload()V",
        )
    }
}
