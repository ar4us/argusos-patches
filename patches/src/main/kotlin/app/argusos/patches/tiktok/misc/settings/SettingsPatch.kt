package app.argusos.patches.tiktok.misc.settings
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/tiktok/settings/TikTokActivityHook;"

val settingsPatch = bytecodePatch(
    name = "Settings",
    description = "Adds ArgusOS settings to TikTok.",
) {
    ...
    apply {
        ...
        // Create a settings entry for 'argusos settings' and add it to settings fragment
