package app.argusos.patches.tiktok.misc.spoof.sim
...
val sIMSpoofPatch = bytecodePatch(
    ...
    apply {
                ...
                with(classDef.firstMethod(method)) {
                    while (!patches.isEmpty()) {
                        ...
                        addInstructions(
                            index + 2,
                            """
                                invoke-static {v$resultReg}, Lapp/argusos/extension/tiktok/spoof/sim/SpoofSimPatch;->$replacement(Ljava/lang/String;)Ljava/lang/String;
        ...
        settingsStatusLoadMethod.addInstruction(
            0,
            "invoke-static {}, Lapp/argusos/extension/tiktok/settings/SettingsStatus;->enableSimSpoof()V",
        )
    }
}
