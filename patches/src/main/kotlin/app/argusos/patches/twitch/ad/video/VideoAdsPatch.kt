package app.argusos.patches.twitch.ad.video
...
import app.argusos.patches.twitch.ad.shared.util.ReturnMethod
import app.argusos.patches.twitch.ad.shared.util.adPatch
...
val blockVideoAdsPatch = bytecodePatch(
    ...
    val conditionCall = "Lapp/argusos/extension/twitch/patches/VideoAdsPatch;->shouldBlockVideoAds()Z"
        ...
        adPatch(conditionCall, skipLabelName) { createConditionInstructions, blockMethods ->
            ...
            apply {
                ...
                PreferenceScreen.ADS.CLIENT_SIDE.addPreferences(
                    SwitchPreference("argusos_block_video_ads"),
                )
