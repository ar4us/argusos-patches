package app.argusos.patches.twitch.chat.antidelete
...
val showDeletedMessagesPatch = bytecodePatch(
    ...
    fun createSpoilerConditionInstructions(register: String = "v0") = """
        invoke-static {}, Lapp/argusos/extension/twitch/patches/ShowDeletedMessagesPatch;->shouldUseSpoiler()Z
    ...
    apply {
        ...
        PreferenceScreen.CHAT.GENERAL.addPreferences(
            ListPreference("argusos_show_deleted_messages"),
        )
        ...
        chatUtilCreateDeletedSpanMethod.apply {
            addInstructionsWithLabels(
                0,
                """
                    invoke-static {p2}, Lapp/argusos/extension/twitch/patches/ShowDeletedMessagesPatch;->reformatDeletedMessage(Landroid/text/Spanned;)Landroid/text/Spanned;
