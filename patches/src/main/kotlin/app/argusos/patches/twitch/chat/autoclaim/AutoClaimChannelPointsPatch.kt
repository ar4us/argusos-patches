package app.argusos.patches.twitch.chat.autoclaim
...
val autoClaimChannelPointsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.CHAT.GENERAL.addPreferences(
            SwitchPreference("argusos_auto_claim_channel_points"),
        )
        ...
        communityPointsButtonViewDelegateMethod.apply {
            ...
            addInstructionsWithLabels(
                ...
                """
                    invoke-static {}, Lapp/argusos/extension/twitch/patches/AutoClaimChannelPointsPatch;->shouldAutoClaim()Z
                    move-result v0
