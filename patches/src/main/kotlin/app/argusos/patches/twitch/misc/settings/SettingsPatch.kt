package app.argusos.patches.twitch.misc.settings
...
private const val ARGUSOS_SETTINGS_MENU_ITEM_NAME = "RevancedSettings"
private const val ARGUSOS_SETTINGS_MENU_ITEM_ID = 0x7
private const val ARGUSOS_SETTINGS_MENU_ITEM_TITLE_RES = "argusos_settings"
private const val ARGUSOS_SETTINGS_MENU_ITEM_ICON_RES = "ic_settings"
...
private const val EXTENSION_PACKAGE = "app/argusos/extension/twitch"
...
val settingsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.MISC.OTHER.addPreferences(
            ...
            SwitchPreference(
                key = "argusos_debug",
                titleKey = "argusos_twitch_debug_title",
                summaryOnKey = "argusos_twitch_debug_summary_on",
                summaryOffKey = "argusos_twitch_debug_summary_off",
            ),
        )
        ...
        settingsMenuItemEnumMethod.injectMenuItem(
            ARGUSOS_SETTINGS_MENU_ITEM_NAME,
            ARGUSOS_SETTINGS_MENU_ITEM_ID,
            ARGUSOS_SETTINGS_MENU_ITEM_TITLE_RES,
            ARGUSOS_SETTINGS_MENU_ITEM_ICON_RES,
        )
        ...
        menuGroupsUpdatedMethod.addInstructions(
            0,
            """
                sget-object v0, $MENU_ITEM_ENUM_CLASS_DESCRIPTOR->$ARGUSOS_SETTINGS_MENU_ITEM_NAME:$MENU_ITEM_ENUM_CLASS_DESCRIPTOR 
...
internal object PreferenceScreen : BasePreferenceScreen() {
    val ADS = CustomScreen("argusos_ads_screen")
    val CHAT = CustomScreen("argusos_chat_screen")
    val MISC = CustomScreen("argusos_misc_screen")

    internal class CustomScreen(key: String) : Screen(key) {
        /* Categories */
        val GENERAL = CustomCategory("argusos_general_category")
        val OTHER = CustomCategory("argusos_other_category")
        val CLIENT_SIDE = CustomCategory("argusos_client_ads_category")
        val SURESTREAM = CustomCategory("argusos_surestream_ads_category")
        ...
        internal inner class CustomCategory(key: String) : Category(key) {
            ...
            override fun transform(): PreferenceCategory = PreferenceCategory(
                ...
                tag = "app.argusos.extension.twitch.settings.preference.CustomPreferenceCategory",
            )
        }
    }

    override fun commit(screen: app.argusos.patches.shared.misc.settings.preference.PreferenceScreenPreference) {
