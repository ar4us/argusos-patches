package app.argusos.patches.youtube.ad.general
...
import app.argusos.patches.shared.misc.fix.verticalscroll.verticalScrollPatch
...
import app.argusos.patches.youtube.misc.engagement.addEngagementPanelIdHook
...
import app.argusos.util.injectHideViewCall
import com.android.tools.smali.dexlib2.Opcode
import com.android.tools.smali.dexlib2.iface.instruction.FiveRegisterInstruction
import com.android.tools.smali.dexlib2.iface.instruction.TwoRegisterInstruction

private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/litho/AdsFilter;"
...
private val hideAdsResourcePatch = resourcePatch {
    ...
    apply {
        ...
        PreferenceScreen.ADS.addPreferences(
            SwitchPreference("argusos_hide_end_screen_store_banner"),
            SwitchPreference("argusos_hide_fullscreen_ads"),
            SwitchPreference("argusos_hide_general_ads"),
            SwitchPreference("argusos_hide_merchandise_banners"),
            SwitchPreference("argusos_hide_paid_promotion_label"),
            SwitchPreference("argusos_hide_player_popup_ads"),
            SwitchPreference("argusos_hide_self_sponsor_ads"),
            SwitchPreference("argusos_hide_shopping_links"),
            SwitchPreference("argusos_hide_view_products_banner"),
            SwitchPreference("argusos_hide_youtube_premium_promotions")
        )

        addLithoFilter("Lapp/argusos/extension/youtube/patches/litho/AdsFilter;")
