package app.argusos.patches.youtube.ad.video
...
val videoAdsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.ADS.addPreferences(
            SwitchPreference("argusos_hide_video_ads"),
        )

        loadVideoAdsMethod.addInstructionsWithLabels(
            0,
            """
                invoke-static { }, Lapp/argusos/extension/youtube/patches/VideoAdsPatch;->shouldShowAds()Z
                move-result v0
