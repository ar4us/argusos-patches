package app.argusos.patches.youtube.interaction.doubletap
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/DisableDoubleTapActionsPatch;"
...
val disableDoubleTapActionsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_disable_chapter_skip_double_tap"),
        )
