...
import app.argusos.patches.youtube.misc.playservice.is_19_17_or_greater
...
import app.argusos.util.findInstructionIndicesReversed
import app.argusos.util.getReference
import com.android.tools.smali.dexlib2.Opcode
import com.android.tools.smali.dexlib2.iface.instruction.OneRegisterInstruction
import com.android.tools.smali.dexlib2.iface.reference.MethodReference

private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/argusos/extension/youtube/patches/SlideToSeekPatch;"
...
val enableSlideToSeekPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.SEEKBAR.addPreferences(
            SwitchPreference("argusos_slide_to_seek"),
        )
