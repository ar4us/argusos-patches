package app.argusos.patches.youtube.layout.branding.header
...
import app.argusos.util.findElementByAttributeValueOrThrow
...
private val logoResourceNames = arrayOf(
    "argusos_header_minimal",
    "argusos_header_rounded",
)

/**
 * Custom header resource/file name.
 */
private const val CUSTOM_HEADER_RESOURCE_NAME = "argusos_header_custom"
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/ChangeHeaderPatch;"
...
val changeHeaderPatch = resourcePatch(
    ...
    apply {
        ...
        PreferenceScreen.GENERAL.addPreferences(
            if (custom == null) {
                ListPreference("argusos_header_logo")
            } else {
                ListPreference(
                    key = "argusos_header_logo",
                    entriesKey = "argusos_header_logo_custom_entries",
                    entryValuesKey = "argusos_header_logo_custom_entry_values",
                )
            },
        )
