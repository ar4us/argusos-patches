package app.argusos.patches.youtube.layout.buttons.overlay
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/HidePlayerOverlayButtonsPatch;"
...
val hidePlayerOverlayButtonsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_hide_autoplay_button"),
            SwitchPreference("argusos_hide_captions_button"),
            SwitchPreference("argusos_hide_cast_button"),
            SwitchPreference("argusos_hide_collapse_button"),
            SwitchPreference("argusos_hide_fullscreen_button"),
            SwitchPreference("argusos_hide_player_control_buttons_background"),
            SwitchPreference("argusos_hide_player_previous_next_buttons"),
        )
