package app.argusos.patches.youtube.layout.hide.endscreencards
...
private val hideEndScreenCardsResourcePatch = resourcePatch {
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_hide_end_screen_cards"),
        )
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/HideEndScreenCardsPatch;"
