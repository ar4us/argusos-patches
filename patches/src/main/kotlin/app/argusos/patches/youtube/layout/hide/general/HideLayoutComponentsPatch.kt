package app.argusos.patches.youtube.layout.hide.general
...
import app.argusos.patches.youtube.misc.playservice.is_20_21_or_greater
...
import app.argusos.util.findFreeRegister
import app.argusos.util.findInstructionIndicesReversedOrThrow
import app.argusos.util.getReference
import app.argusos.util.indexOfFirstInstructionReversedOrThrow
...
private const val LAYOUT_COMPONENTS_FILTER_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/litho/LayoutComponentsFilter;"
private const val DESCRIPTION_COMPONENTS_FILTER_CLASS_NAME =
    "Lapp/argusos/extension/youtube/patches/litho/DescriptionComponentsFilter;"
private const val COMMENTS_FILTER_CLASS_NAME =
    "Lapp/argusos/extension/youtube/patches/litho/CommentsFilter;"
private const val CUSTOM_FILTER_CLASS_NAME =
    "Lapp/argusos/extension/shared/patches/litho/CustomFilter;"
private const val KEYWORD_FILTER_CLASS_NAME =
    "Lapp/argusos/extension/youtube/patches/litho/KeywordContentFilter;"
...
val hideLayoutComponentsPatch = hideLayoutComponentsPatch(
    ...
    PreferenceScreen.ADS.addPreferences(
        ...
        SwitchPreference("argusos_hide_creator_store_shelf")
    )

    PreferenceScreen.PLAYER.addPreferences(
        PreferenceScreenPreference(
            key = "argusos_hide_description_components_screen",
            preferences = setOf(
                SwitchPreference("argusos_hide_ai_generated_video_summary_section"),
                SwitchPreference("argusos_hide_ask_section"),
                SwitchPreference("argusos_hide_attributes_section"),
                SwitchPreference("argusos_hide_chapters_section"),
                SwitchPreference("argusos_hide_course_progress_section"),
                SwitchPreference("argusos_hide_explore_section"),
                SwitchPreference("argusos_hide_explore_course_section"),
                SwitchPreference("argusos_hide_explore_podcast_section"),
                SwitchPreference("argusos_hide_featured_links_section"),
                SwitchPreference("argusos_hide_featured_places_section"),
                SwitchPreference("argusos_hide_featured_videos_section"),
                SwitchPreference("argusos_hide_gaming_section"),
                SwitchPreference("argusos_hide_how_this_was_made_section"),
                SwitchPreference("argusos_hide_hype_points"),
                SwitchPreference("argusos_hide_info_cards_section"),
                SwitchPreference("argusos_hide_key_concepts_section"),
                SwitchPreference("argusos_hide_music_section"),
                SwitchPreference("argusos_hide_subscribe_button"),
                SwitchPreference("argusos_hide_transcript_section"),
                SwitchPreference("argusos_hide_quizzes_section")
            ),
        ),
        PreferenceScreenPreference(
            "argusos_comments_screen",
            preferences = setOf(
                SwitchPreference("argusos_hide_comments_ai_chat_summary"),
                SwitchPreference("argusos_hide_comments_ai_summary"),
                SwitchPreference("argusos_hide_comments_channel_guidelines"),
                SwitchPreference("argusos_hide_comments_by_members_header"),
                SwitchPreference("argusos_hide_comments_section"),
                SwitchPreference("argusos_hide_comments_section_in_home_feed"),
                SwitchPreference("argusos_hide_comments_community_guidelines"),
                SwitchPreference("argusos_hide_comments_create_a_short_button"),
                SwitchPreference("argusos_hide_comments_emoji_and_timestamp_buttons"),
                SwitchPreference("argusos_hide_comments_preview_comment"),
                SwitchPreference("argusos_hide_comments_thanks_button"),
            ),
            sorting = Sorting.UNSORTED,
        ),
        SwitchPreference("argusos_hide_channel_bar"),
        SwitchPreference("argusos_hide_channel_watermark"),
        SwitchPreference("argusos_hide_crowdfunding_box"),
        SwitchPreference("argusos_hide_emergency_box"),
        SwitchPreference("argusos_hide_info_panels"),
        SwitchPreference("argusos_hide_join_membership_button"),
        SwitchPreference("argusos_hide_live_chat_replay_button"),
        SwitchPreference("argusos_hide_medical_panels"),
        SwitchPreference("argusos_hide_quick_actions"),
        SwitchPreference("argusos_hide_related_videos"),
        SwitchPreference("argusos_hide_subscribers_community_guidelines"),
        SwitchPreference("argusos_hide_timed_reactions"),
        SwitchPreference("argusos_hide_video_title")
    )

    PreferenceScreen.FEED.addPreferences(
        PreferenceScreenPreference(
            key = "argusos_hide_keyword_content_screen",
            sorting = Sorting.UNSORTED,
            preferences = setOf(
                SwitchPreference("argusos_hide_keyword_content_home"),
                SwitchPreference("argusos_hide_keyword_content_subscriptions"),
                SwitchPreference("argusos_hide_keyword_content_search"),
                TextPreference(
                    "argusos_hide_keyword_content_phrases",
                    inputType = InputType.TEXT_MULTI_LINE
                ),
                NonInteractivePreference(
                    key = "argusos_hide_keyword_content_about",
                    tag = "app.argusos.extension.shared.settings.preference.BulletPointPreference",
                ),
                NonInteractivePreference(
                    key = "argusos_hide_keyword_content_about_whole_words",
                    tag = "app.argusos.extension.youtube.settings.preference.HTMLPreference",
                ),
            ),
        ),
        PreferenceScreenPreference(
            key = "argusos_hide_filter_bar_screen",
            preferences = setOf(
                SwitchPreference("argusos_hide_filter_bar_feed_in_feed"),
                SwitchPreference("argusos_hide_filter_bar_feed_in_related_videos"),
                SwitchPreference("argusos_hide_filter_bar_feed_in_search"),
                SwitchPreference("argusos_hide_filter_bar_feed_in_history"),
            ),
        ),
        PreferenceScreenPreference(
            key = "argusos_channel_screen",
            preferences = setOf(
                PreferenceCategory(
                    titleKey = null,
                    sorting = Sorting.UNSORTED,
                    ...
                    preferences = setOf(
                        SwitchPreference("argusos_hide_channel_tab"),
                        TextPreference(
                            "argusos_hide_channel_tab_filter_strings",
                            inputType = InputType.TEXT_MULTI_LINE
                        ),
                    )
                ),
                SwitchPreference("argusos_hide_community_button"),
                SwitchPreference("argusos_hide_for_you_shelf"),
                SwitchPreference("argusos_hide_join_button"),
                SwitchPreference("argusos_hide_links_preview"),
                SwitchPreference("argusos_hide_members_shelf"),
                SwitchPreference("argusos_hide_store_button"),
                SwitchPreference("argusos_hide_subscribe_button_in_channel_page"),
            ),
        ),
        SwitchPreference("argusos_hide_album_cards"),
        SwitchPreference("argusos_hide_artist_cards"),
        SwitchPreference("argusos_hide_chips_shelf"),
        SwitchPreference("argusos_hide_community_posts"),
        SwitchPreference("argusos_hide_compact_banner"),
        SwitchPreference("argusos_hide_expandable_card"),
        PreferenceCategory(
            titleKey = null,
            sorting = Sorting.UNSORTED,
            tag = "app.argusos.extension.shared.settings.preference.NoTitlePreferenceCategory",
            preferences = setOf(
                SwitchPreference("argusos_hide_feed_flyout_menu"),
                TextPreference(
                    "argusos_hide_feed_flyout_menu_filter_strings",
                    inputType = InputType.TEXT_MULTI_LINE
                ),
            )
        ),
        SwitchPreference("argusos_hide_floating_microphone_button"),
        SwitchPreference(
            key = "argusos_hide_horizontal_shelves",
            tag = "app.argusos.extension.shared.settings.preference.BulletPointSwitchPreference",
        ),
        SwitchPreference("argusos_hide_image_shelf"),
        SwitchPreference("argusos_hide_latest_posts"),
        SwitchPreference("argusos_hide_latest_videos_button"),
        SwitchPreference("argusos_hide_mix_playlists"),
        SwitchPreference("argusos_hide_movies_section"),
        SwitchPreference("argusos_hide_notify_me_button"),
        SwitchPreference("argusos_hide_playables"),
        SwitchPreference("argusos_hide_show_more_button"),
        SwitchPreference("argusos_hide_surveys"),
        SwitchPreference("argusos_hide_ticket_shelf"),
        SwitchPreference("argusos_hide_upload_time"),
        SwitchPreference("argusos_hide_video_recommendation_labels"),
        SwitchPreference("argusos_hide_view_count"),
        SwitchPreference("argusos_hide_visual_spacer"),
        SwitchPreference("argusos_hide_doodles"),
    )

    if (is_20_21_or_greater) {
        PreferenceScreen.FEED.addPreferences(
            SwitchPreference("argusos_hide_you_may_like_section")
        )
    }
