package app.argusos.patches.youtube.layout.hide.rollingnumber
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/DisableRollingNumberAnimationsPatch;"
...
val disableRollingNumberAnimationsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_disable_rolling_number_animations"),
        )
