package app.argusos.patches.youtube.layout.hide.shorts
...
import app.argusos.patches.youtube.misc.playservice.*
...
private val hideShortsComponentsResourcePatch = resourcePatch {
    ...
    apply {
        ...
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_hide_shorts_channel"),
            SwitchPreference("argusos_hide_shorts_home"),
            SwitchPreference("argusos_hide_shorts_search"),
            SwitchPreference("argusos_hide_shorts_subscriptions"),
            SwitchPreference("argusos_hide_shorts_video_description"),
            SwitchPreference("argusos_hide_shorts_history"),

            PreferenceScreenPreference(
                key = "argusos_shorts_player_screen",
                ...
                preferences = setOf(
                    ...
                    //SwitchPreference("argusos_hide_shorts_like_fountain"),
                    SwitchPreference("argusos_hide_shorts_like_button"),
                    SwitchPreference("argusos_hide_shorts_dislike_button"),
                    SwitchPreference("argusos_hide_shorts_comments_button"),
                    SwitchPreference("argusos_hide_shorts_share_button"),
                    SwitchPreference("argusos_hide_shorts_remix_button"),
                    SwitchPreference("argusos_hide_shorts_sound_button"),

                    // Upper and middle area of the player.
                    SwitchPreference("argusos_hide_shorts_join_button"),
                    SwitchPreference("argusos_hide_shorts_subscribe_button"),
                    SwitchPreference("argusos_hide_shorts_paused_overlay_buttons"),

                    // Suggested actions.
                    SwitchPreference("argusos_hide_shorts_preview_comment"),
                    SwitchPreference("argusos_hide_shorts_save_sound_button"),
                    SwitchPreference("argusos_hide_shorts_use_sound_button"),
                    SwitchPreference("argusos_hide_shorts_use_template_button"),
                    SwitchPreference("argusos_hide_shorts_upcoming_button"),
                    SwitchPreference("argusos_hide_shorts_effect_button"),
                    SwitchPreference("argusos_hide_shorts_green_screen_button"),
                    SwitchPreference("argusos_hide_shorts_hashtag_button"),
                    SwitchPreference("argusos_hide_shorts_live_preview"),
                    SwitchPreference("argusos_hide_shorts_new_posts_button"),
                    SwitchPreference("argusos_hide_shorts_shop_button"),
                    SwitchPreference("argusos_hide_shorts_tagged_products"),
                    SwitchPreference("argusos_hide_shorts_search_suggestions"),
                    SwitchPreference("argusos_hide_shorts_super_thanks_button"),
                    SwitchPreference("argusos_hide_shorts_stickers"),

                    // Bottom of the screen.
                    SwitchPreference("argusos_hide_shorts_ai_button"),
                    SwitchPreference("argusos_hide_shorts_auto_dubbed_label"),
                    SwitchPreference("argusos_hide_shorts_location_label"),
                    SwitchPreference("argusos_hide_shorts_channel_bar"),
                    SwitchPreference("argusos_hide_shorts_info_panel"),
                    SwitchPreference("argusos_hide_shorts_full_video_link_label"),
                    SwitchPreference("argusos_hide_shorts_video_title"),
                    SwitchPreference("argusos_hide_shorts_sound_metadata_label"),
                    SwitchPreference("argusos_hide_shorts_navigation_bar"),
                ),
            )
        )
...
private const val FILTER_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/litho/ShortsFilter;"
