package app.argusos.patches.youtube.layout.hide.signintotvpopup
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/DisableSignInToTVPopupPatch;"
...
val disableSignInToTVPopupPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_disable_sign_in_to_tv_popup"),
        )
