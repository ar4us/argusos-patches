package app.argusos.patches.youtube.layout.returnyoutubedislike
...
import app.argusos.patches.youtube.shared.conversionContextToStringMethod
import app.argusos.patches.youtube.shared.rollingNumberTextViewAnimationUpdateMethodMatch
import app.argusos.patches.youtube.video.videoid.hookPlayerResponseVideoId
...
import app.argusos.util.cloneMutableAndPreserveParameters
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/ReturnYouTubeDislikePatch;"

private const val FILTER_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/litho/ReturnYouTubeDislikeFilter;"
...
val returnYouTubeDislikePatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.RETURN_YOUTUBE_DISLIKE.addPreferences(
            SwitchPreference("argusos_ryd_enabled"),
            SwitchPreference("argusos_ryd_shorts"),
            SwitchPreference("argusos_ryd_dislike_percentage"),
            SwitchPreference("argusos_ryd_compact_layout"),
            SwitchPreference("argusos_ryd_estimated_like"),
            SwitchPreference("argusos_ryd_toast_on_connection_error"),
            NonInteractivePreference(
                key = "argusos_ryd_attribution",
                tag = "app.argusos.extension.youtube.returnyoutubedislike.ui.ReturnYouTubeDislikeAboutPreference",
                selectable = true,
            ),
            PreferenceCategory(
                key = "argusos_ryd_statistics_category",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = emptySet(), // Preferences are added by custom class at runtime.
                tag = "app.argusos.extension.youtube.returnyoutubedislike.ui.ReturnYouTubeDislikeDebugStatsPreferenceCategory",
            ),
        )
