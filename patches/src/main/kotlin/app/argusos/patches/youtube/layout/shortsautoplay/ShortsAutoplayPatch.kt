package app.argusos.patches.youtube.layout.shortsautoplay
...
import app.argusos.patches.youtube.misc.playservice.is_20_09_or_greater
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/ShortsAutoplayPatch;"
...
val shortsAutoplayPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_shorts_autoplay"),
        )

        if (is_19_34_or_greater) {
            PreferenceScreen.SHORTS.addPreferences(
                SwitchPreference("argusos_shorts_autoplay_background"),
            )
        }
