package app.argusos.patches.youtube.layout.shortsplayer

import app.argusos.util.findFreeRegister
import app.argusos.util.registersUsed
...
import app.argusos.patches.youtube.layout.player.fullscreen.openVideosFullscreenHookPatch
...
import app.argusos.patches.youtube.misc.playservice.is_21_07_or_greater
...
import app.argusos.patches.youtube.video.information.playbackStartDescriptorToStringMethodMatch
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/OpenShortsInRegularPlayerPatch;"
...
val openShortsInRegularPlayerPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.SHORTS.addPreferences(
            ListPreference("argusos_shorts_player_type"),
        )
