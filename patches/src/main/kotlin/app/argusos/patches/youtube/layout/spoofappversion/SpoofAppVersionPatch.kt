package app.argusos.patches.youtube.layout.spoofappversion
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/spoof/SpoofAppVersionPatch;"
    ...
    apply {
        ...
        PreferenceScreen.GENERAL.addPreferences(
            ...
            PreferenceCategory(
                ...
                preferences = setOf(
                    SwitchPreference("argusos_spoof_app_version"),
                    ListPreference("argusos_spoof_app_version_target")
                ),
            ),
        )
