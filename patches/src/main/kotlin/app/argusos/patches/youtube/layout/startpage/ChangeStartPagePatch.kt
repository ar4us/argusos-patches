package app.argusos.patches.youtube.layout.startpage
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/ChangeStartPagePatch;"
    ...
    apply {
        ...
        PreferenceScreen.GENERAL.addPreferences(
            PreferenceCategory(
                ...
                preferences = setOf(
                    ListPreference(
                        key = "argusos_change_start_page",
                        tag = "app.argusos.extension.shared.settings.preference.SortedListPreference",
                    ),
                    SwitchPreference("argusos_change_start_page_always"),
                ),
            ),
        )
