package app.argusos.patches.youtube.layout.startupshortsreset
...
import app.argusos.patches.youtube.misc.playservice.is_21_03_or_greater
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/DisableResumingStartupShortsPlayerPatch;"
...
val disableResumingShortsOnStartupPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_disable_resuming_shorts_player"),
        )
