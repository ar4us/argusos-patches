package app.argusos.patches.youtube.misc.audiofocus
...
private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/argusos/extension/youtube/patches/PauseOnAudioInterruptPatch;"
...
val pauseOnAudioInterruptPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_pause_on_audio_interrupt"),
        )
