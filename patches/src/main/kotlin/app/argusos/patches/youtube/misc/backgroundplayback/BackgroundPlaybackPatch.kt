package app.argusos.patches.youtube.misc.backgroundplayback
...
import app.argusos.patches.youtube.misc.playservice.is_20_29_or_greater
...
import app.argusos.patches.youtube.shared.backgroundPlaybackManagerShortsMethod
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/BackgroundPlaybackPatch;"
...
val removeBackgroundPlaybackRestrictionsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_shorts_disable_background_playback"),
        )
