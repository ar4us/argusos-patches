package app.argusos.patches.youtube.misc.dimensions.spoof
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/spoof/SpoofDeviceDimensionsPatch;"
...
val spoofDeviceDimensionsPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_spoof_device_dimensions"),
        )
