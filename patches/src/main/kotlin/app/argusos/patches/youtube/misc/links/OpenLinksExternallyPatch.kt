...
val openLinksExternallyPatch = bytecodePatch(
        ...
        transformInstructionsPatch(
            ...
            transform = { mutableMethod, entry ->
                ...
                mutableMethod.addInstructions(
                    intentStringIndex + 1,
                    """
                        invoke-static {v$register}, Lapp/argusos/extension/youtube/patches/OpenLinksExternallyPatch;->getIntent(Ljava/lang/String;)Ljava/lang/String;
    ...
    apply {
        ...
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_external_browser"),
        )
    }
}
