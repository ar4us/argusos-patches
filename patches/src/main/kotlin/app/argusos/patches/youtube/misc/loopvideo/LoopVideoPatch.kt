package app.argusos.patches.youtube.misc.loopvideo
...
import app.argusos.patches.youtube.misc.loopvideo.button.loopVideoButtonPatch
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/LoopVideoPatch;"
...
val loopVideoPatch = bytecodePatch(
    ...
    apply {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_loop_video"),
        )
