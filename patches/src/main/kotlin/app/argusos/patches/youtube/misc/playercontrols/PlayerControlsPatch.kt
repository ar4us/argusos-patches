package app.argusos.patches.youtube.misc.playercontrols
...
internal val playerControlsResourcePatch = resourcePatch {
    ...
    apply {
        ...
        // The fullscreen button is lower than the ArgusOS buttons (unpatched app bug).
        ...
        addTopControl = { resourceDirectoryName ->
            ...
            "RelativeLayout".copyXmlNode(
                ...
                val votingButtonId = "@+id/argusos_sb_voting_button"
...
internal const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/PlayerControlsPatch;"
