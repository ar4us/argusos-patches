package app.argusos.patches.youtube.video.codecs
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/DisableVideoCodecsPatch;"
...
val disableVideoCodecsPatch = bytecodePatch(
    ...
    dependsOn(
        ...
        transformInstructionsPatch(
            filterMap = filterMap@{ classDef, _, instruction, instructionIndex ->
                if (classDef.type.startsWith("Lapp/argusos/")) {
    ...
    apply {
        ...
        PreferenceScreen.VIDEO.addPreferences(
            SwitchPreference("argusos_disable_hdr_video"),
            SwitchPreference("argusos_force_avc_codec"),
        )
