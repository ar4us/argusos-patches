...
import app.argusos.patches.youtube.video.information.EXTENSION_VIDEO_QUALITY_INTERFACE
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/playback/quality/HidePremiumVideoQualityPatch;"
...
internal val hidePremiumVideoQualityPatch = bytecodePatch {
    ...
    apply {
        ...
        settingsMenuVideoQualityGroup.add(
            SwitchPreference("argusos_hide_premium_video_quality")
        )
