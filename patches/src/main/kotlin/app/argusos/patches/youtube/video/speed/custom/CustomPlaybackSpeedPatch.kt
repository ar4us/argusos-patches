package app.argusos.patches.youtube.video.speed.custom
...
import app.argusos.patches.youtube.misc.recyclerviewtree.hook.addRecyclerViewTreeHook
import app.argusos.patches.youtube.misc.recyclerviewtree.hook.recyclerViewTreeHookPatch
import app.argusos.patches.youtube.misc.settings.settingsPatch
import app.argusos.patches.youtube.video.speed.settingsMenuVideoSpeedGroup
import app.argusos.util.indexOfFirstLiteralInstructionOrThrow
...
private const val FILTER_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/litho/PlaybackSpeedMenuFilter;"

private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/playback/speed/CustomPlaybackSpeedPatch;"
...
internal val customPlaybackSpeedPatch = bytecodePatch(
    ...
    apply {
        ...
        settingsMenuVideoSpeedGroup.addAll(
            listOf(
                SwitchPreference("argusos_custom_speed_menu"),
                SwitchPreference("argusos_restore_old_speed_menu"),
                TextPreference(
                    "argusos_custom_playback_speeds",
        ...
        if (is_19_47_or_greater) {
            settingsMenuVideoSpeedGroup.add(
                TextPreference("argusos_speed_tap_and_hold", inputType = InputType.NUMBER_DECIMAL),
            )
        }
