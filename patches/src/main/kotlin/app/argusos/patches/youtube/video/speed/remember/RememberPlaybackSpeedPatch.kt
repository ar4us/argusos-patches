package app.argusos.patches.youtube.video.speed.remember
...
import app.argusos.patches.youtube.video.information.*
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/argusos/extension/youtube/patches/playback/speed/RememberPlaybackSpeedPatch;"
...
internal val rememberPlaybackSpeedPatch = bytecodePatch {
    ...
    apply {
        ...
        settingsMenuVideoSpeedGroup.addAll(
            listOf(
                ListPreference(
                    key = "argusos_playback_speed_default",
                    // Entries and values are set by the extension code based on the actual speeds available.
                    entriesKey = null,
                    entryValuesKey = null,
                    tag = "app.argusos.extension.youtube.settings.preference.CustomVideoSpeedListPreference",
                ),
                SwitchPreference("argusos_remember_playback_speed_last_selected"),
                SwitchPreference("argusos_remember_playback_speed_last_selected_toast"),
            ),
        )
